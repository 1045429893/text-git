...
{
    private static final String UUID_SOURCE = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
    ...
    public static Object unserialize(byte[] bytes)
    {
        ...
        {
            hdLog.error("反序列化异常.cause by=" + e.getMessage(), e);
            return null;
        }
        finally
        {
            if (ois != null)
            {
                ...
                {
                    hdLog.error("反序列化关闭ois异常.cause by=" + e.getMessage(), e);
                }
            }
            if (bais != null)
            {
                ...
                {
                    hdLog.error("反序列化关闭bais异常.cause by=" + e.getMessage(), e);
                }
            }
        }
    }
