...
<form class="layui-form" action="" id="sform">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="username" maxlength="20" required  lay-verify="required|rusername" placeholder="请输入用户名" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-form-mid layui-word-aux"> <span id = "myspan" style="color: red" ></span>  </div>

        <%--<label class="layui-form-label">密码框： </label>--%>
        <%--<div class="layui-input-inline"><input id = "myinput" type="text" maxlength="16"  placeholder = "请输入6~16个字符" onkeyup="check()" />--%>
            <%--</div>--%>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="phone" lay-verify="sjh"  placeholder="请输入手机号码" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">真实姓名</label>
        <div class="layui-input-block">
            <input type="text" name="compellation" maxlength="10"  placeholder="请输入真实姓名" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">用户类型</label>
        <div class="layui-input-block">
            <c:forEach items="${userTypes}" var="userType" varStatus="s">
                <input type="radio" name="userType" value="${userType.key}" title="${userType.value}"
...
<script>
    ...
    layui.use('form', function(){
        ...
        form.on('submit(formDemo)', function(data){
            $.post("${path}system/user/addSysUserInfo.do",$("#sform").serialize(),function(cbd) {
                if(cbd.code=="0"){
