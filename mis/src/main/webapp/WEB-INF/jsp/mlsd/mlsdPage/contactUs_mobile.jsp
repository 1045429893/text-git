...
<form class="layui-form" action="" id="sform">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div>
                    <input type="text" value="${mlsdMobileContactUsVo.text1}" id="text1" name="text1" class="layui-input">
                </div>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div>
                    <input type="text" value="${mlsdMobileContactUsVo.text2}" id="text2" name="text2" class="layui-input">
                </div>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div>
                    <input type="text" value="${mlsdMobileContactUsVo.text3}" id="text3" name="text3" class="layui-input">
                </div>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv01">
                    <input type="hidden" value="${mlsdMobileContactUsVo.imgUrl}" id="picPath01" name="picPath01">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic01">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdMobileContactUsVo.imgUrl}"
...
<script>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(save)', function (data) {
            $.post("${path}mlsd/contactUs/updateMlsdMobileContactUs.do", data.field, function (cbd) {
                if (cbd.code == "0") {
                    layer.open({
                        title: '提示'
                        , content: '保存成功'
