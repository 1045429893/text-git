...
<form class="layui-form" action="" id="sform">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">展示图1：</label>
            <div class="layui-input-inline">
                <div id="fileDiv01">
                    <input type="hidden" value="${mlsdStoreDisplayVo.storeDisplayImgUrl1}" id="picPath01" name="picPath01">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <div>
                        ...
                        <textarea id="text" name="text" class="layui-textarea"  rows="3" cols="40">${mlsdStoreDisplayVo.storeDisplayText}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">展示图2:</label>
            <div class="layui-input-inline">
                <div id="fileDiv02">
                    <input type="hidden" value="${mlsdStoreDisplayVo.storeDisplayImgUrl2}" id="picPath02" name="picPath02">
        ...
        <div class="layui-inline">
            <label class="layui-form-label">展示图3:</label>
            <div class="layui-input-inline">
                <div id="fileDiv03">
                    <input type="hidden" value="${mlsdStoreDisplayVo.storeDisplayImgUrl3}" id="picPath03" name="picPath03">
...
<script>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(save)', function (data) {
            $.post("${path}mlsd/storeDisplay/updateMlsdMobileStoreDisplay.do", data.field, function (cbd) {
                if (cbd.code == "0") {
                    layer.open({
                        title: '提示'
                        , content: '保存成功'
