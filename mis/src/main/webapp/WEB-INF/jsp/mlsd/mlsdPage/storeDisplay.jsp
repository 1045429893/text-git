...
<form class="layui-form" action="" id="sform">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv01">
                    <input type="hidden" value="${mlsdStoreDisplayVo.banner1}" id="picPath01" name="picPath01">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic01" >
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStoreDisplayVo.banner1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">门店展示图片1:</label>
            <div class="layui-input-inline">
                <div id="fileDiv02">
                    <input type="hidden" value="${mlsdStoreDisplayVo.storeDisplayImgUrl1}" id="picPath02" name="picPath02">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic02">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStoreDisplayVo.storeDisplayImgUrl1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">门店展示图片2：</label>
            <div class="layui-input-inline">
                <div id="fileDiv03">
                    <input type="hidden" value="${mlsdStoreDisplayVo.storeDisplayImgUrl2}" id="picPath03" name="picPath03">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic03">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStoreDisplayVo.storeDisplayImgUrl2}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">门店展示图片3：</label>
            <div class="layui-input-inline">
                <div id="fileDiv04">
                    <input type="hidden" value="${mlsdStoreDisplayVo.storeDisplayImgUrl3}" id="picPath04" name="picPath04">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic04">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStoreDisplayVo.storeDisplayImgUrl3}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">门店展示图片4：</label>
            <div class="layui-input-inline">
                <div id="fileDiv05">
                    <input type="hidden" value="${mlsdStoreDisplayVo.storeDisplayImgUrl4}" id="picPath05" name="picPath05">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic05">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStoreDisplayVo.storeDisplayImgUrl4}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">制作展示标题：</label>
            <div class="layui-input-inline">
                <div id="fileDiv06">
                    <input type="hidden" value="${mlsdStoreDisplayVo.makeShowTitleImgUrl}" id="picPath06" name="picPath06">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic06">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStoreDisplayVo.makeShowTitleImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">制作展示图片1：</label>
            <div class="layui-input-inline">
                <div id="fileDiv07">
                    <input type="hidden" value="${mlsdStoreDisplayVo.makeShowImgUrl1}" id="picPath07" name="picPath07">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic07">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStoreDisplayVo.makeShowImgUrl1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">制作展示图片2：</label>
            <div class="layui-input-inline">
                <div id="fileDiv08">
                    <input type="hidden" value="${mlsdStoreDisplayVo.makeShowImgUrl2}" id="picPath08" name="picPath08">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic08">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStoreDisplayVo.makeShowImgUrl2}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">制作展示图片3：</label>
            <div class="layui-input-inline">
                <div id="fileDiv09">
                    <input type="hidden" value="${mlsdStoreDisplayVo.makeShowImgUrl3}" id="picPath09" name="picPath09">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic09">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStoreDisplayVo.makeShowImgUrl3}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
...
<script>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(save)', function (data) {
            $.post("${path}mlsd/storeDisplay/updateMlsdStoreDisplay.do", data.field, function (cbd) {
                if (cbd.code == "0") {
                    layer.open({
                        title: '提示'
                        , content: '保存成功'
