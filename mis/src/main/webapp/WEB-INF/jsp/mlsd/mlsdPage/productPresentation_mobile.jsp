...
<form class="layui-form" action="" id="sform">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">新品推荐标题图片：</label>
            <div class="layui-input-inline">
                <div id="fileDiv01">
                    <input type="hidden" value="${mlsdMobileProductPresentationVo.newProductsTitleImgUrl}" id="picPath01" name="picPath01">

                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic01" >
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdMobileProductPresentationVo.newProductsTitleImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv02">
                    <input type="hidden" value="${mlsdMobileProductPresentationVo.newProductsImgUrl1}" id="picPath02" name="picPath02">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic02">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdMobileProductPresentationVo.newProductsImgUrl1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv03">
                    <input type="hidden" value="${mlsdMobileProductPresentationVo.newProductsImgUrl2}" id="picPath03" name="picPath03">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic03">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdMobileProductPresentationVo.newProductsImgUrl2}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv04">
                    <input type="hidden" value="${mlsdMobileProductPresentationVo.newProductsImgUrl3}" id="picPath04" name="picPath04">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic04">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdMobileProductPresentationVo.newProductsImgUrl3}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv05">
                    <input type="hidden" value="${mlsdMobileProductPresentationVo.newProductsImgUrl4}" id="picPath05" name="picPath05">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic05">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdMobileProductPresentationVo.newProductsImgUrl4}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食标题图片：</label>
            <div class="layui-input-inline">
                <div id="fileDiv06">
                    <input type="hidden" value="${mlsdMobileProductPresentationVo.signatureCuisineimgTitleImgUrl}" id="picPath06" name="picPath06">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic06">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdMobileProductPresentationVo.signatureCuisineimgTitleImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv07">
                    <input type="hidden" value="${mlsdMobileProductPresentationVo.signatureCuisineimgUrl1}" id="picPath07" name="picPath07">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic07">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdMobileProductPresentationVo.signatureCuisineimgUrl1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv08">
                    <input type="hidden" value="${mlsdMobileProductPresentationVo.signatureCuisineimgUrl2}" id="picPath08" name="picPath08">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic08">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdMobileProductPresentationVo.signatureCuisineimgUrl2}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv09">
                    <input type="hidden" value="${mlsdMobileProductPresentationVo.signatureCuisineimgUrl3}" id="picPath09" name="picPath09">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic09">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdMobileProductPresentationVo.signatureCuisineimgUrl3}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv10">
                    <input type="hidden" value="${mlsdMobileProductPresentationVo.signatureCuisineimgUrl4}" id="picPath10" name="picPath10">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic10">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdMobileProductPresentationVo.signatureCuisineimgUrl4}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv11">
                    <input type="hidden" value="${mlsdMobileProductPresentationVo.productListImgUrl}" id="picPath11" name="picPath11">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic11">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdMobileProductPresentationVo.productListImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
...
<script>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(save)', function (data) {
            $.post("${path}mlsd/productPresentation/updateMlsdMobileProductPresentation.do", data.field, function (cbd) {
                if (cbd.code == "0") {
                    layer.open({
                        title: '提示'
                        , content: '保存成功'
