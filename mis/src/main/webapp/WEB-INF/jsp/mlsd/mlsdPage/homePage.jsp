...
<form class="layui-form" action="" id="sform">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">首页轮播图1：</label>
            <div class="layui-input-inline">
                <div id="fileDiv01">
                    <input type="hidden" value="${mlsdHomePageVo.banner1}" id="picPath01" name="picPath01">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic01" >
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.banner1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">首页轮播图2-1:</label>
            <div class="layui-input-inline">
                <div id="fileDiv02">
                    <input type="hidden" value="${mlsdHomePageVo.banner21}" id="picPath02" name="picPath02">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic02">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.banner21}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">首页轮播图2-2：</label>
            <div class="layui-input-inline">
                <div id="fileDiv03">
                    <input type="hidden" value="${mlsdHomePageVo.banner22}" id="picPath03" name="picPath03">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic03">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.banner22}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">首页轮播图2-3：</label>
            <div class="layui-input-inline">
                <div id="fileDiv04">
                    <input type="hidden" value="${mlsdHomePageVo.banner23}" id="picPath04" name="picPath04">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic04">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.banner23}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">首页轮播图3-1：</label>
            <div class="layui-input-inline">
                <div id="fileDiv05">
                    <input type="hidden" value="${mlsdHomePageVo.banner31}" id="picPath05" name="picPath05">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic05">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.banner31}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">首页轮播图3-2：</label>
            <div class="layui-input-inline">
                <div id="fileDiv06">
                    <input type="hidden" value="${mlsdHomePageVo.banner32}" id="picPath06" name="picPath06">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic06">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.banner32}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv07">
                    <input type="hidden" value="${mlsdHomePageVo.introduceIntroImgUrl}" id="picPath07" name="picPath07">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic07">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.introduceIntroImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv08">
                    <input type="hidden" value="${mlsdHomePageVo.introduceProductImgUrl}" id="picPath08" name="picPath08">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic08">
                        <img class="layui-upload-img"   src="${frontPicPath}${mlsdHomePageVo.introduceProductImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv09">
                    <input type="hidden" value="${mlsdHomePageVo.introduceTextImgUrl}" id="picPath09" name="picPath09">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic09">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.introduceTextImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">盈利方式图片介绍：</label>
            <div class="layui-input-inline">
                <div id="fileDiv10">
                    <input type="hidden" value="${mlsdHomePageVo.profitImgUrl}" id="picPath10" name="picPath10">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic10">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.profitImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">盈利方式文字介绍图片：</label>
            <div class="layui-input-inline">
                <div id="fileDiv11">
                    <input type="hidden" value="${mlsdHomePageVo.profitTextImgUrl}" id="picPath11" name="picPath11">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic11">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.profitTextImgUrl}" style='width: 100px;height: 100px'/>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食1：</label>
            <div class="layui-input-inline">
                <div id="fileDiv12">
                    <input type="hidden" value="${mlsdHomePageVo.shopSign1}" id="picPath12" name="picPath12">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic12">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.shopSign1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食1背景：</label>
            <div class="layui-input-inline">
                <div id="fileDiv13">
                    <input type="hidden" value="${mlsdHomePageVo.shopSignBackground1}" id="picPath13" name="picPath13">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic13">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.shopSignBackground1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食2：</label>
            <div class="layui-input-inline">
                <div id="fileDiv14">
                    <input type="hidden" value="${mlsdHomePageVo.shopSign2}" id="picPath14" name="picPath14">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic14">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.shopSign2}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食2背景：</label>
            <div class="layui-input-inline">
                <div id="fileDiv15">
                    <input type="hidden" value="${mlsdHomePageVo.shopSignBackground2}" id="picPath15" name="picPath15">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic15">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.shopSignBackground2}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食3：</label>
            <div class="layui-input-inline">
                <div id="fileDiv16">
                    <input type="hidden" value="${mlsdHomePageVo.shopSign3}" id="picPath16" name="picPath16">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic16">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.shopSign3}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食3背景：</label>
            <div class="layui-input-inline">
                <div id="fileDiv17">
                    <input type="hidden" value="${mlsdHomePageVo.shopSignBackground3}" id="picPath17" name="picPath17">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic17">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.shopSignBackground3}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
                        <button id="browse17">选择文件</button>
                    </div>
                    <div id="uploadInfo17"></div>
                </div>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食4：</label>
            <div class="layui-input-inline">
                <div id="fileDiv18">
                    <input type="hidden" value="${mlsdHomePageVo.shopSign4}" id="picPath18" name="picPath18">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic18">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.shopSign4}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
                        <button id="browse18">选择文件</button>
                    </div>
                    <div id="uploadInfo18"></div>
                </div>
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食4背景：</label>
            <div class="layui-input-inline">
                <div id="fileDiv19">
                    <input type="hidden" value="${mlsdHomePageVo.shopSignBackground4}" id="picPath19" name="picPath19">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic19">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdHomePageVo.shopSignBackground4}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
                        <button id="browse19">选择文件</button>
                    </div>
                    <div id="uploadInfo19"></div>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(save)', function (data) {
            $.post("${path}mlsd/homePage/updateMlsdHomePage.do", data.field, function (cbd) {
                if (cbd.code == "0") {
                    layer.open({
                        title: '提示'
                        , content: '保存成功'
