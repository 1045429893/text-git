    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv01">
                    <input type="hidden" value="${mlsdStrengthVo.banner1}" id="picPath01" name="picPath01">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic01">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStrengthVo.banner1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">实力展示图片1:</label>
            <div class="layui-input-inline">
                <div id="fileDiv02">
                    <input type="hidden" value="${mlsdStrengthVo.strengthImgUrl1}" id="picPath02" name="picPath02">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic02">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStrengthVo.strengthImgUrl1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">实力展示图片2：</label>
            <div class="layui-input-inline">
                <div id="fileDiv03">
                    <input type="hidden" value="${mlsdStrengthVo.strengthImgUrl2}" id="picPath03" name="picPath03">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic03">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStrengthVo.strengthImgUrl2}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">实力展示图片3：</label>
            <div class="layui-input-inline">
                <div id="fileDiv04">
                    <input type="hidden" value="${mlsdStrengthVo.strengthImgUrl3}" id="picPath04" name="picPath04">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic04">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdStrengthVo.strengthImgUrl3}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">诚信展示图片1：</label>
            <div class="layui-input-inline">
                <div id="fileDiv08">
                    <input type="hidden" value="${mlsdStrengthVo.integrityShowImgUrl1}" id="picPath08" name="picPath08">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic08">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStrengthVo.integrityShowImgUrl1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">诚信展示图片2：</label>
            <div class="layui-input-inline">
                <div id="fileDiv09">
                    <input type="hidden" value="${mlsdStrengthVo.integrityShowImgUrl2}" id="picPath09" name="picPath09">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic09">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStrengthVo.integrityShowImgUrl2}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">签约案例：</label>
            <div class="layui-input-inline">
                <div id="fileDiv10">
                    <input type="hidden" value="${mlsdStrengthVo.signUpCaseImgUrl}" id="picPath10" name="picPath10">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic10">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdStrengthVo.signUpCaseImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
...
<script>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(save)', function (data) {
            $.post("${path}mlsd/strength/updateMlsdStrength.do", data.field, function (cbd) {
                if (cbd.code == "0") {
                    layer.open({
                        title: '提示'
                        , content: '保存成功'
