...
<form class="layui-form" action="" id="sform">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv01">
                    <input type="hidden" value="${mlsdProductPresentationVo.banner1}" id="picPath01" name="picPath01">

                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic01" >
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.banner1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">新品推荐图片1:</label>
            <div class="layui-input-inline">
                <div id="fileDiv02">
                    <input type="hidden" value="${mlsdProductPresentationVo.newRoductsImgUrl1}" id="picPath02" name="picPath02">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic02">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.newRoductsImgUrl1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
                        <button id="browse02">选择文件</button>
                    </div>
                    <div>
                        <input type="text" value="${mlsdProductPresentationVo.newRoductsTitle1}" id="newRoductsTitle1" name="newRoductsTitle1" placeholder="请输入新品1名称">
                    </div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">新品推荐图片2：</label>
            <div class="layui-input-inline">
                <div id="fileDiv03">
                    <input type="hidden" value="${mlsdProductPresentationVo.newRoductsImgUrl2}" id="picPath03" name="picPath03">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic03">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.newRoductsImgUrl2}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
                        <button id="browse03">选择文件</button>
                    </div>
                    <div>
                        <input type="text" value="${mlsdProductPresentationVo.newRoductsTitle2}" id="newRoductsTitle2" name="newRoductsTitle2" placeholder="请输入新品2名称">
                    </div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">新品推荐图片3：</label>
            <div class="layui-input-inline">
                <div id="fileDiv04">
                    <input type="hidden" value="${mlsdProductPresentationVo.newRoductsImgUrl3}" id="picPath04" name="picPath04">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic04">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.newRoductsImgUrl3}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
                        <button id="browse04">选择文件</button>
                    </div>
                    <div>
                        <input type="text" value="${mlsdProductPresentationVo.newRoductsTitle3}" id="newRoductsTitle3" name="newRoductsTitle3" placeholder="请输入新品3名称">
                    </div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">新品推荐图片4：</label>
            <div class="layui-input-inline">
                <div id="fileDiv05">
                    <input type="hidden" value="${mlsdProductPresentationVo.newRoductsImgUrl4}" id="picPath05" name="picPath05">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic05">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.newRoductsImgUrl4}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
                        <button id="browse05">选择文件</button>
                    </div>
                    <div>
                        <input type="text" value="${mlsdProductPresentationVo.newRoductsTitle4}" id="newRoductsTitle4" name="newRoductsTitle4" placeholder="请输入新品4名称">
                    </div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">新品推荐图片5：</label>
            <div class="layui-input-inline">
                <div id="fileDiv06">
                    <input type="hidden" value="${mlsdProductPresentationVo.newRoductsImgUrl5}" id="picPath06" name="picPath06">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic06">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.newRoductsImgUrl5}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
                        <button id="browse06">选择文件</button>
                    </div>
                    <div>
                        <input type="text" value="${mlsdProductPresentationVo.newRoductsTitle5}" id="newRoductsTitle5" name="newRoductsTitle5" placeholder="请输入新品5名称">
                    </div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">新品推荐图片6：</label>
            <div class="layui-input-inline">
                <div id="fileDiv07">
                    <input type="hidden" value="${mlsdProductPresentationVo.newRoductsImgUrl6}" id="picPath07" name="picPath07">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic07">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.newRoductsImgUrl6}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
                        <button id="browse07">选择文件</button>
                    </div>
                    <div>
                        <input type="text" value="${mlsdProductPresentationVo.newRoductsTitle6}" id="newRoductsTitle6" name="newRoductsTitle6" placeholder="请输入新品6名称">
                    </div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">新品推荐图片7：</label>
            <div class="layui-input-inline">
                <div id="fileDiv08">
                    <input type="hidden" value="${mlsdProductPresentationVo.newRoductsImgUrl7}" id="picPath08" name="picPath08">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic08">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.newRoductsImgUrl7}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
                        <button id="browse08">选择文件</button>
                    </div>
                    <div>
                        <input type="text" value="${mlsdProductPresentationVo.newRoductsTitle7}" id="newRoductsTitle7" name="newRoductsTitle7" placeholder="请输入新品7名称">
                    </div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">新品推荐图片8：</label>
            <div class="layui-input-inline">
                <div id="fileDiv09">
                    <input type="hidden" value="${mlsdProductPresentationVo.newRoductsImgUrl8}" id="picPath09" name="picPath09">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic09">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdProductPresentationVo.newRoductsImgUrl8}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
                        <button id="browse09">选择文件</button>
                    </div>
                    <div>
                        <input type="text" value="${mlsdProductPresentationVo.newRoductsTitle8}" id="newRoductsTitle8" name="newRoductsTitle8" placeholder="请输入新品8名称">
                    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食图片1：</label>
            <div class="layui-input-inline">
                <div id="fileDiv10">
                    <input type="hidden" value="${mlsdProductPresentationVo.signatureCuisineimgUrl1}" id="picPath10" name="picPath10">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic10">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.signatureCuisineimgUrl1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食图片2：</label>
            <div class="layui-input-inline">
                <div id="fileDiv11">
                    <input type="hidden" value="${mlsdProductPresentationVo.signatureCuisineimgUrl2}" id="picPath11" name="picPath11">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic11">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.signatureCuisineimgUrl2}" style='width: 100px;height: 100px'/>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食图片3：</label>
            <div class="layui-input-inline">
                <div id="fileDiv12">
                    <input type="hidden" value="${mlsdProductPresentationVo.signatureCuisineimgUrl3}" id="picPath12" name="picPath12">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic12">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.signatureCuisineimgUrl3}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食图片4：</label>
            <div class="layui-input-inline">
                <div id="fileDiv13">
                    <input type="hidden" value="${mlsdProductPresentationVo.signatureCuisineimgUrl4}" id="picPath13" name="picPath13">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic13">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.signatureCuisineimgUrl4}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食图片5：</label>
            <div class="layui-input-inline">
                <div id="fileDiv14">
                    <input type="hidden" value="${mlsdProductPresentationVo.signatureCuisineimgUrl5}" id="picPath14" name="picPath14">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic14">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.signatureCuisineimgUrl5}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
                        <button id="browse14">选择文件</button>
                    </div>
                    <div id="uploadInfo14"></div>
                </div>
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">招牌美食图片6：</label>
            <div class="layui-input-inline">
                <div id="fileDiv15">
                    <input type="hidden" value="${mlsdProductPresentationVo.signatureCuisineimgUrl6}" id="picPath15" name="picPath15">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic15">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.signatureCuisineimgUrl6}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
                        <button id="browse15">选择文件</button>
                    </div>
                    <div id="uploadInfo15"></div>
                </div>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">产品清单图片：</label>
            <div class="layui-input-inline">
                <div id="fileDiv16">
                    <input type="hidden" value="${mlsdProductPresentationVo.productListImgUrl}" id="picPath16" name="picPath16">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic16">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdProductPresentationVo.productListImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
                        <button id="browse16">选择文件</button>
                    </div>
                    <div id="uploadInfo16"></div>
                </div>
            </div>
        </div>
...
<script>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(save)', function (data) {
            $.post("${path}mlsd/productPresentation/updateMlsdProductPresentation.do", data.field, function (cbd) {
                if (cbd.code == "0") {
                    layer.open({
                        title: '提示'
                        , content: '保存成功'
