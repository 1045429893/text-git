...
<form class="layui-form" action="" id="sform">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv01">
                    <input type="hidden" value="${mlsdContactUsVo.banner1}" id="picPath01" name="picPath01">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic01">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdContactUsVo.banner1}"
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv02">
                    <input type="hidden" value="${mlsdContactUsVo.imgUrl}" id="picPath02" name="picPath02">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic02">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdContactUsVo.imgUrl}"
                             style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">联系图标：</label>
            <div class="layui-input-inline">
                <div id="fileDiv03">
                    <input type="hidden" value="${mlsdContactUsVo.contactIcon}" id="picPath03" name="picPath03">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic03">
                        <img class="layui-upload-img" src="${frontPicPath}${mlsdContactUsVo.contactIcon}"
                             style='width: 100px;height: 100px'/>
                    </div>
                    <div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">欢迎语第一行：</label>
            <div class="layui-input-inline">
                <div>
                    <input type="text" value="${mlsdContactUsVo.text1}" id="text1" name="text1" class="layui-input">
                </div>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">欢迎语第二行：</label>
            <div class="layui-input-inline">
                <div>
                    <input type="text" value="${mlsdContactUsVo.text2}" id="text2" name="text2" class="layui-input">
                </div>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">欢迎语第三行：</label>
            <div class="layui-input-inline">
                <div>
                    <input type="text" value="${mlsdContactUsVo.text3}" id="text3" name="text3" class="layui-input">
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(save)', function (data) {
            $.post("${path}mlsd/contactUs/updateMlsdContactUs.do", data.field, function (cbd) {
                if (cbd.code == "0") {
                    layer.open({
                        title: '提示'
                        , content: '保存成功'
