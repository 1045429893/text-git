    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv01">
                    <input type="hidden" value="${mlsdItemAdvantageVo.banner1}" id="picPath01" name="picPath01">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic01" >
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdItemAdvantageVo.banner1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">公司展示文字图片:</label>
            <div class="layui-input-inline">
                <div id="fileDiv02">
                    <input type="hidden" value="${mlsdItemAdvantageVo.companyShowsTextImgUrl}" id="picPath02" name="picPath02">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic02">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdItemAdvantageVo.companyShowsTextImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">公司展示标题图片：</label>
            <div class="layui-input-inline">
                <div id="fileDiv03">
                    <input type="hidden" value="${mlsdItemAdvantageVo.companyShowsTitleImgUrl}" id="picPath03" name="picPath03">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic03">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdItemAdvantageVo.companyShowsTitleImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">公司展示图片：</label>
            <div class="layui-input-inline">
                <div id="fileDiv04">
                    <input type="hidden" value="${mlsdItemAdvantageVo.companyShowsImgUrl}" id="picPath04" name="picPath04">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic04">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdItemAdvantageVo.companyShowsImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">公司展示优势图片：</label>
            <div class="layui-input-inline">
                <div id="fileDiv05">
                    <input type="hidden" value="${mlsdItemAdvantageVo.companyShowsAdvantageImgUrl}" id="picPath05" name="picPath05">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic05">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdItemAdvantageVo.companyShowsAdvantageImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            <label class="layui-form-label">加盟支持图片：</label>
            <div class="layui-input-inline">
                <div id="fileDiv06">
                    <input type="hidden" value="${mlsdItemAdvantageVo.supportImgUrl}" id="picPath06" name="picPath06">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic06">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdItemAdvantageVo.supportImgUrl}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
...
<script>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(save)', function (data) {
            $.post("${path}mlsd/itemAdvantage/updateMlsdItemAdvantage.do", data.field, function (cbd) {
                if (cbd.code == "0") {
                    layer.open({
                        title: '提示'
                        , content: '保存成功'
