...
<form class="layui-form" action="" id="sform">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">简介第一行：</label>
            <div class="layui-input-inline">
                <div>
                    <input type="text" value="${mlsdMobileItemAdvantageVo.text1}" id="text1" name="text1" class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">简介第二行：</label>
            <div class="layui-input-inline">
                <div>
                    <input type="text" value="${mlsdMobileItemAdvantageVo.text2}" id="text2" name="text2" class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv01">
                    <input type="hidden" value="${mlsdMobileItemAdvantageVo.showImage1}" id="picPath01" name="picPath01">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic01" >
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdMobileItemAdvantageVo.showImage1}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div id="fileDiv02">
                    <input type="hidden" value="${mlsdMobileItemAdvantageVo.showImage2}" id="picPath02" name="picPath02">
                    <div class="layui-upload-list" style="width: 100px;height: 100px" id="pic02">
                        <img class="layui-upload-img"  src="${frontPicPath}${mlsdMobileItemAdvantageVo.showImage2}" style='width: 100px;height: 100px'/>
                    </div>
                    <div>
...
<script>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(save)', function (data) {
            $.post("${path}mlsd/itemAdvantage/updateMlsdMobileItemAdvantage.do", data.field, function (cbd) {
                if (cbd.code == "0") {
                    layer.open({
                        title: '提示'
                        , content: '保存成功'
