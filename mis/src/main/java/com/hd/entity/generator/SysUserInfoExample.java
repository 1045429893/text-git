...
public class SysUserInfoExample implements Serializable
{
	 ...
	 public static class ColumnName implements Serializable
    {
        ...
        {
            if(this.quereyColumnNameStr.length()==0){
                this.quereyColumnNameStr="username";
            }else{
                this.quereyColumnNameStr=this.quereyColumnNameStr+",username";
            }
            return this;
        }

		public ColumnName addPasswordColumn()
        {
            if(this.quereyColumnNameStr.length()==0){
                this.quereyColumnNameStr="password";
            }else{
                this.quereyColumnNameStr=this.quereyColumnNameStr+",password";
            }
            return this;
        }

		public ColumnName addCompellationColumn()
        {
            if(this.quereyColumnNameStr.length()==0){
                this.quereyColumnNameStr="compellation";
            }else{
                this.quereyColumnNameStr=this.quereyColumnNameStr+",compellation";
            }
            return this;
        }

		public ColumnName addPhoneColumn()
        {
            if(this.quereyColumnNameStr.length()==0){
                this.quereyColumnNameStr="phone";
            }else{
                this.quereyColumnNameStr=this.quereyColumnNameStr+",phone";
            }
            return this;
        }

		public ColumnName addUserTypeColumn()
        {
            if(this.quereyColumnNameStr.length()==0){
                this.quereyColumnNameStr="user_type";
            }else{
                this.quereyColumnNameStr=this.quereyColumnNameStr+",user_type";
            }
            return this;
        }

		public ColumnName addStatusColumn()
        {
            if(this.quereyColumnNameStr.length()==0){
                this.quereyColumnNameStr="status";
            }else{
                this.quereyColumnNameStr=this.quereyColumnNameStr+",status";
            }
            return this;
        }
