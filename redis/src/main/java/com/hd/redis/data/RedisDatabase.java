...
import com.hd.redis.innerTools.RedisPools;
import com.hd.redis.log.RedisLog;

//http://redis.readthedocs.org/en/latest/文档网址
...
public class RedisDatabase
{
    ...
    /**
     * @param id 例：redis.goo.com:6369:2
     */
    public RedisDatabase(String id, String passWord)
    {
        this.pool = RedisPools.getPool(id, passWord);
        this.id = id;
    }
    ...
    public Jedis getJedis()
    {
        ...
        {
            RedisLog.fatal("从连接池获取连接异常" + this.id, e);
            return null;
        }
    }
    ...
    public String getRedisError()
    {
        try
        {
            return "redis异常【" + Thread.currentThread().getStackTrace()[2].getMethodName() + "】";
        }
        catch (Exception e)
        {
            RedisLog.error("getRedisError异常", e);
            return "redis异常【未知】";
        }
    }
