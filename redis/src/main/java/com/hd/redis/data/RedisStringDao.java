...
public class RedisStringDao extends RedisDatabase
{
    ...
    public RedisStringDao(String id, String passWord)
    {
        super(id, passWord);
    }
    ...
    public long delete(String key)
    {
     ...
     /**
      * @Author 马兴亮
      * @Date 2017/10/9 12:55
      * @params *m 之类模糊匹配的字母
      * @return key列表
      * @Description 根据模糊检索出所有符合条件的key
      */
    public Set<String> keys(String pattern){
        ...
        * 描述： 生产队列
        * 作者: shangyuren
        * 修改日期：2018/12/21 9:32
        * @param key 队列标识
        * @param value 队列内容
        */
    public void setQueue(String key, String value)
    {
        Jedis jedis = this.getJedis();
        try
        {
     ...
     * 修改日期：2018/12/21 9:32
     * @param key 队列标识
     * @param timrout 设置超时时间为0，表示无限期阻塞
     */

    public List<String> getQueue(int timrout, String key)
    {
        Jedis jedis = this.getJedis();
        List<String> value = null;
        try
        {
            value = jedis.brpop(timrout, key);
        }
        catch (Exception e)
        {
            RedisLog.error(this.getRedisError(), e);
