...
@author Robot
*/
public class MlsdMobileStrength implements Serializable {
   ...
   //实力展示图片7
   private String strengthImgUrl7;
   //实力展示图片8
   private String strengthImgUrl8;
   ...
   public void setStrengthImgUrl7(String strengthImgUrl7){
         this.strengthImgUrl7 = strengthImgUrl7;
   }
   public String getStrengthImgUrl7(){
      return this.strengthImgUrl7;
   }
   public void setStrengthImgUrl8(String strengthImgUrl8){
         this.strengthImgUrl8 = strengthImgUrl8;
   }
   public String getStrengthImgUrl8(){
      return this.strengthImgUrl8;
   }
}