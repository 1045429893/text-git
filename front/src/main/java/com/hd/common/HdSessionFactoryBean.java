 ...
 */
public class HdSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent>
{
    ...
    private String environment = HdSessionFactoryBean.class.getSimpleName();
